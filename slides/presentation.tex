...
%   CHI: ablation-comparaisons-variante-a, ablation-comparaisons-variante-c, ablation-ecart-complet, ablation-ecart-variante-a, ablation-ecart-variante-c, ablation-f-variante-c, admissions-2024
...
\begin{frame}{L'ablation : la F-mesure ne bouge pas, la marge s'effondre}
  ...
  \begin{center}
    \begin{tabular}{@{}lrr@{}}
      ...
      Variante C & \chiffre{ablation-comparaisons-variante-c} & \chiffre{ablation-ecart-variante-c} \\
      \hline
    \end{tabular}
  \end{center}
  \medskip
