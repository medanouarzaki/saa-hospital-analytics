...
\textbf{Ce qui établit le constat} autorise à dire qu'un problème existe. Ce ne peut pas être une
valeur affichée par le tableau de bord : les relations qui la gouvernent ont été injectées, et les
relire à la sortie serait circulaire. Le constat vient d'une source extérieure au jeu — un rapport
de contrôle, une publication statistique, une observation au poste — ou il n'existe pas, et le
rapport le dit.

\textbf{Ce que l'indicateur démontre} est autre chose : que la chaîne sait produire le nombre, à la
maille utile, à partir des tables. Le jour où elle sera branchée sur les données réelles, le nombre
sera un constat ; aujourd'hui, il est une capacité.

\textbf{Aucun effort n'est chiffré et aucun effet n'est quantifié.} Chaque bloc dit ce que l'action
suppose et par quelle mesure on constaterait son effet.
