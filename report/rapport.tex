...
% L'inclusion d'images. Le paquet est du lot `graphics`, requis par LaTeX 2e et
% présent dans toute distribution, et le choix est MESURÉ et non supposé de deux
